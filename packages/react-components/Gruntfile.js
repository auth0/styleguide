...
const pkgShortName = 'react-components'; // TODO: get this name from the folder name
    ...
    aws_s3: {
      ...
      clean: {
        files: [
          ...
          { action: 'delete', dest: `${cdnFolder}/${pkg.version}/${pkgShortName}.js` },
          { action: 'delete', dest: `${cdnFolder}/latest/${pkgShortName}.css` },
          { action: 'delete', dest: `${cdnFolder}/latest/${pkgShortName}.js` }
        ]
      },
      publish: {
        files: [{
